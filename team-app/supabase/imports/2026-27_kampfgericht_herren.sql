...
begin
  ...
  insert into public.officiating_tasks (officiating_game_id, task_type)
    select v_game_id, t from (values ('anschreiber')) as x(t);
  ...
  insert into public.officiating_games (game_date, game_time, opponent_teams, location)
    ...
    returning id into v_game_id;
  insert into public.officiating_tasks (officiating_game_id, task_type)
    select v_game_id, t from (values ('anschreiber'), ('zeit')) as x(t);
  ...
  insert into public.officiating_games (game_date, game_time, opponent_teams, location)
    ...
    returning id into v_game_id;
  insert into public.officiating_tasks (officiating_game_id, task_type)
    select v_game_id, t from (values ('anschreiber'), ('zeit'), ('uhr')) as x(t);
